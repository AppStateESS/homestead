...
var AssignByFloor = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'div',
            null,
            React.createElement(Options, _extends({}, this.state, { updateAssignmentType: this.updateAssignmentType })),
            React.createElement(Halls, { hallList: this.state.hallList, assignmentType: this.state.currentAssignmentType })
        );
    }
});
...
var DropSelect = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'select',
            { className: 'form-control', id: this.props.selectId, value: this.props.default, onChange: this.props.onChange },
...
var Halls = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(Floors, { key: this.state.timestamp, floorDisabled: this.state.floorDisabled, floorList: this.state.floors, assignmentType: this.props.assignmentType })
        );
    }
});
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: 'room-list' },
                React.createElement(Rooms, { roomList: this.state.rooms, display: this.state.displayStatus, assignmentType: this.props.assignmentType })
            )
        );
    }
        ...
        if (this.props.display == 'show') {
            ...
            return React.createElement(
                ...
                this.props.roomList.map(function (room, i) {
                    return React.createElement(Room, { key: i, room: room, assignmentType: this.props.assignmentType, tab: i });
                }, this)
            );
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                null,
                'Room# ',
                this.props.room.room_number,
                ' - ',
                this.props.room.gender
            ),
            this.props.room.beds.map(function (bed, i) {
                bed.tab = i + this.props.tab * bedCount + 1;
                return React.createElement(Bed, { bed: bed, key: i, assignmentType: this.props.assignmentType });
            }, this)
        );
    }
});
...
var Bed = React.createClass({
    ...
    loadingMessage: function () {
        this.setAssignment(React.createElement(
            'div',
    ...
    alertTag: function (message, type, dismiss) {
        ...
        if (dismiss) {
            ...
            button = React.createElement(
                'button',
                { type: 'button', className: 'close', onClick: this.resetForm, 'aria-label': 'Close' },
                React.createElement(
                    'span',
                    { 'aria-hidden': 'true' },
                    '\xD7'
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'big',
                    null,
                    React.createElement('i', { className: 'fa fa-bed fa-lg' }),
                    ' ',
                    this.props.bed.bedroom_label,
                    this.props.bed.bed_letter
                )
            ),
            React.createElement(
                'div',
...
var Assigned = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement('i', { className: 'fa-lg pull-right fa fa-check-circle' }),
            this.props.student
        );
    }
});
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'button',
                    { 'aria-expanded': 'false', className: buttonClass + ' btn btn-lg dropdown-toggle', 'data-toggle': 'dropdown', disabled: buttonDisabled, type: 'button' },
                ...
                React.createElement(
                    ...
                    this.props.listing.map(function (listItem, i) {
                        return React.createElement(DropDownChoice, { key: i, onClick: this.props.onClick.bind(null, i), title: listItem.title });
                    }, this)
                )
            )
        );
