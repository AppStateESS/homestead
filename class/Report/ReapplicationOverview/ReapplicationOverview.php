...
class ReapplicationOverview extends Report implements iCsvReport {
    ...
    public function execute()
    {
         ...
         * Outstanding Invites *
         */
        $this->data['PENDING_ROOMMATE_INVITES']        = LotteryProcess::countOutstandingRoommateInvites($lotteryTerm);
        ...
        $this->data['TOTAL_PENDING_INVITES']   = $this->data['PENDING_SOPH_INVITES'] + $this->data['PENDING_JR_INVITES'] + $this->data['PENDING_SR_INVITES'] + $this->data['PENDING_ROOMMATE_INVITES'];
