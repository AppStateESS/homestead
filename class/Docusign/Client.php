...
class Client
{
    ...
    public function authenticate()
    {
        ...
        try {
            ...
            $response = $http->send($request,
                    ['headers' => ['Content-Type' => 'application/json', 'Accept' => 'application/json', 'X-DocuSign-Authentication' => $this->getAuthHeader()]]);
    ...
    public function getHeaders($accept = 'Accept: application/json',
