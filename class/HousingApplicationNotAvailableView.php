...
class HousingApplicationNotAvailableView extends View {
    ...
    public function show()
    {
        ...
        if($this->feature->getStartDate() > time()){
            $tpl['DEADLINE'] = 'It is too soon to complete your application. The On-campus Housing Application will be availble on here ' . HMS_Util::getFriendlyDate($this->feature->getStartDate());
