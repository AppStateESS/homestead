...
class ReapplicationOverview extends Report implements iCsvReport {
    ...
    public function execute()
    {
        ...
        $numLotteryEntries = PHPWS_DB::getOne("SELECT count(*) FROM hms_new_application JOIN hms_lottery_application ON hms_new_application.id = hms_lottery_application.id WHERE (hms_new_application.term = $lotteryTerm)");
        ...
        $this->data['LOTTERY_APPLICATIONS']    = $numLotteryEntries;
