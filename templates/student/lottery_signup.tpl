<div class="hms">
    <div class="box">
        ...
        <table>
            <tr>
                <th colspan="2">Preferred Roommate User Names</th>
            </tr>
            <tr>
