...
<div class="col-md-8">
  <p>Residential Learning Communities (RLCs) are a unique housing opportunity.
    Ranked as a 2010 Best College for Learning Communities by U.S. News & World
    Report, Appalachian's RLCs offer great experiences for all community members.
    In addition, research shows students who participate in Residential Learning
    Communities have a higher GPA and enjoy a better college experience.  One of
    the best ways to develop strong friendships and succeed in college is to join
    a Residential Learning Community!
  </p>

  <p class="lead">
    To learn more about our RLC options, visit the
...
<div class="row">
    <div class="col-md-4 col-md-push-8">
        <div class="alert alert-info">
            <h4>
              ...
              Interested in The Honors College or Watauga Global Community?
            </h4>

            <p>You must apply directly to these two communities through their
              separate application processes.  See the
              <a href="http://www.honors.appstate.edu/" class="alert-link" target="_blank">
                The Honors College
              </a>
              or
              <a href="http://wataugaglobal.appstate.edu/" class="alert-link" target="_blank">
        ...
        <div class="alert alert-info">
            ...
            <p>You cannot be accepted into a Residential Learning Community if
              you have requested a roommate who does not also apply to the same
              community.  In addition, once invited to a community, you can no
              longer request roommates who have not applied to the same community.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-8 col-md-pull-4">
        ...
        <div class="form-group">
            ...
            <textarea name="why_specific_communities" id="phpws_form_why_specific_communities"
              title="Why are you interested in the specific communities you have chosen?"
        ...
        <div class="form-group">
            ...
            <span class="help-block"></span>
            <textarea name="strengths_weaknesses" id="phpws_form_strengths_weaknesses"
              title="What are your strengths and in what areas would you like to improve?"
              rows="15" class="form-control"></textarea>
        </div>
